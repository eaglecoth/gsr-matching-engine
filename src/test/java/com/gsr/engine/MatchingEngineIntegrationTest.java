...
public class MatchingEngineIntegrationTest {
    ...
    public void setup(){
        ...
        solOfferProcessor = new OfferOrderBookProcessor(CcyPair.SOLUSD, orderPool, executionPool, messagePool, queues.get(4), executionPublishQueue, orderIdCounter);
        solBidProcessor = new BidOrderBookProcessor(CcyPair.SOLUSD, orderPool, executionPool, messagePool, queues.get(5), executionPublishQueue, orderIdCounter);
